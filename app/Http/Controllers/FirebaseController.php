...
class FirebaseController extends Controller
{
    ...
    public function firebaseData(Request $request){
...
//            $JSON_DATA= response()->json($data);
    ...
    public function fetchDataFromFirestore(Request $request)
    {
        $RIDER_DATA= 'RidersInformation';
        $FIREBASE_JSON='{
        ...
        $firestore = $database->createFirestore();

        $collectionName = $RIDER_DATA; // Replace with your Firestore collection name
